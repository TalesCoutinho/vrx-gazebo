...
class Model:
    ...
    def xacro_cmd(self):
        ...
        xacro_command.append(f'camera_enabled:=false')
        xacro_command.append(f'gps_enabled:=true')
        xacro_command.append(f'imu_enabled:=true')
        xacro_command.append(f'lidar_enabled:=true')
        xacro_command.append(f'bathymetry_enabled:=true')
        xacro_command.append(f'ground_truth_enabled:=false')
