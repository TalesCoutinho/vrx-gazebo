...
ros2 launch vrx_gz competition.launch.py headless:=true world:=bathymetry urdf:=$URDF_PATH vrx_sensors_enabled:=false gps_enabled:=true imu_enabled:=true lidar_enabled:=true bathymetry_enabled:=true > "$WORKSPACE_DIR"/log/gazebo_log.txt 2>&1 &
SIM_PID=$!
